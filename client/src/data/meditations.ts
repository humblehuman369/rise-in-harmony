 ...
 *
 * Soundscape assignment guidelines (v2):
 *  - Morning meditations: forest (gentle, uplifting) + ambient (stable harmonic chords)
 *  - Stress/anxiety: ocean (slow wave rhythm) or rain (steady, calming) + drone (deep, grounding)
 *  - Focus: wind (minimal, non-distracting) + drone (stable, no random events)
 *  - Sleep: ocean (slow waves) or rain (steady) + drone (deepest, most hypnotic)
 *  - Healing: forest (nurturing) or ocean (cleansing) + ambient (warm harmonics)
 *  - Spiritual: wind (vast, spacious) or silence + crystal (bowl resonance, infrequent strikes)
 */
...
export const MEDITATIONS: MeditationTrack[] = [
  ...
  // ─── STRESS ──────────────────────────────────────────────────────────────────
  {
    ...
    category: "stress",
    durationMinutes: 60,
    description: "A deeply immersive one-hour progressive body scan that systematically releases physical tension stored throughout the body, layer by layer. Continuous non-looping rain soundscape evolves throughout the entire session.",
  ...
  // ─── SLEEP ───────────────────────────────────────────────────────────────────
  {
    ...
    category: "sleep",
    durationMinutes: 60,
    description: "A deeply relaxing one-hour progressive muscle relaxation, body scan, and visualization practice designed to prepare body and mind for deep, restorative sleep. Continuous non-looping soundscape evolves throughout the entire session.",
