        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div style={{ position: 'relative', maxWidth: 720, margin: '0 auto' }}>
            ...
            <div style={{ position: 'relative', zIndex: 1, border: '1px solid rgba(0,212,170,0.22)', boxShadow: '0 0 50px rgba(0,212,170,0.08), 0 24px 48px rgba(0,0,0,0.5)', background: '#000', borderRadius: 12, overflow: 'hidden' }}>
              ...
              <video controls playsInline poster="https://files.manuscdn.com/user_upload_by_module/session_file/110672315/scene2_sound_science_thumb.jpg"
                style={{ display: 'block', width: '100%', aspectRatio: '16/9', background: '#000' }}>
                <source src="https://files.manuscdn.com/user_upload_by_module/session_file/110672315/QqkbTeRcrUGuLPVt.mp4" type="video/mp4" />
              </video>
            </div>
          </div>
