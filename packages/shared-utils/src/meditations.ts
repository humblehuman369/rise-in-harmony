...
export const MEDITATIONS: Meditation[] = [
  ...
  // ─── STRESS ──────────────────────────────────────────────────────────────────
  {
    ...
    durationMinutes: 15,
    description:
      "A progressive body scan that systematically releases physical tension stored throughout the body, leaving you deeply relaxed.",
  ...
  // ─── SLEEP ───────────────────────────────────────────────────────────────────
  {
    ...
    durationMinutes: 20,
    description:
      "A deeply relaxing progressive muscle relaxation and visualization practice designed to prepare body and mind for deep, restorative sleep.",
    benefit:
  ...
  },
  {
    ...
    frequencyRationale:
      "963Hz activates the Crown Chakra and the pineal gland — it is the highest Solfeggio frequency, associated with divine consciousness and universal oneness.",
